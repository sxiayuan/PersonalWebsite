...
export default function FashionSection() {
  const { title, intro, points } = SITE_CONTENT.sections.fashion;

  return (
    <section id="fashionista" className="min-h-screen w-full bg-gradient-to-b from-warmDark to-gray-900 flex items-center justify-center">
