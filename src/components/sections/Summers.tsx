...
export default function SummersSection() {
  const { title, intro, points } = SITE_CONTENT.sections.summers;

  return (
    <section id="summers" className="min-h-screen w-full bg-gradient-to-b from-gray-900 to-warmDark flex items-center justify-center">
